package io.siggi.cubecore.nms.v1_19_R3;
...
public class NMSUtil extends io.siggi.cubecore.nms.NMSUtil {
    ...
    public SkinSettings getSkinSettings(@Nonnull Player p) {
        ...
        return new SkinSettings((Integer) handle.aj().a(PA.getClientSettings()));
    }
    ...
    public void setRenderDistance(@Nonnull org.bukkit.World world, int distance) {
        try {
            org.bukkit.craftbukkit.v1_19_R3.CraftWorld cw = (org.bukkit.craftbukkit.v1_19_R3.CraftWorld) world;
    ...
    public Object createPacketSetSkullProfile(@Nonnull Skull skull, GameProfile gameProfile) {
        ...
        NBTTagCompound tag = tileEntity.aq_();
        if (gameProfile == null) {
            // r = remove
            tag.r("SkullOwner");
        } else {
