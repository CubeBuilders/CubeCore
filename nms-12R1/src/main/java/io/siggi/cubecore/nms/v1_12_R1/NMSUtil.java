package io.siggi.cubecore.nms.v1_12_R1;
...
public class NMSUtil extends io.siggi.cubecore.nms.NMSUtil {
    ...
    public void setRenderDistance(@Nonnull org.bukkit.World world, int distance) {
        try {
            org.bukkit.craftbukkit.v1_12_R1.CraftWorld cw = (org.bukkit.craftbukkit.v1_12_R1.CraftWorld) world;
    ...
    public Object createPacketSetSkullProfile(@Nonnull Skull skull, GameProfile gameProfile) {
        ...
        NBTTagCompound tag = tileEntity.d();
        int x = tag.getInt("x");
        int y = tag.getInt("y");
        int z = tag.getInt("z");
