package io.siggi.cubecore.nms.v1_20_R1;
...
public class NMSUtil extends io.siggi.cubecore.nms.NMSUtil {
    ...
    public SkinSettings getSkinSettings(@Nonnull Player p) {
        ...
        return new SkinSettings((Integer) handle.aj().b(PA.getClientSettings()));
    }
    ...
    public void setRenderDistance(@Nonnull org.bukkit.World world, int distance) {
        try {
            org.bukkit.craftbukkit.v1_20_R1.CraftWorld cw = (org.bukkit.craftbukkit.v1_20_R1.CraftWorld) world;
    ...
    public Object createPacketSetSkullProfile(@Nonnull Skull skull, GameProfile gameProfile) {
        ...
        NBTTagCompound tag = tileEntity.ao_();
        if (gameProfile == null) {
            // r = remove
            tag.r("SkullOwner");
        } else {
