...
public class NMSUtil extends io.siggi.cubecore.nms.NMSUtil {
    ...
    public Object createPacketSetSkullProfile(@Nonnull Skull skull, GameProfile gameProfile) {
        ...
        if (gameProfile == null) {
            ...
            NBTBase gameProfileTag = ResolvableProfile.a.encodeStart((DynamicOpsNBT) DynamicOpsNBT.a, new ResolvableProfile(gameProfile)).getOrThrow();
            // a = set
